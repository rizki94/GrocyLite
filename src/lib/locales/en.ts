export default {
  ...
  warehouse: {
    ...
    stockOpname: {
      ...
      syncFullDatabase: 'Sync Full Database',
      syncingShort: 'Syncing...',
      savedToCache: 'Saved {{count}} products to cache.',
      syncFailed: 'Failed to sync product database',
      updateSo: 'Update SO #{{invoice}}',
      createSo: 'Create Stock Opname',
      approveSo: 'Approve SO #{{invoice}}',
      reopenSo: 'Reopen SO #{{invoice}}',
